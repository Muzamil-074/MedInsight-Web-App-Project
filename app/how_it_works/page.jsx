      ...
      <div className="bg-gradient-to-b from-[#020a10] via-[#024e7c] to-[#02c7e2] text-white min-h-screen px-4 py-8">
        <div className="max-w-5xl mx-auto">
          ...
          <header className="text-center mb-8">
            <h1 className="text-4xl font-bold mb-4 text-center sm:text-5xl">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-center sm:text-3xl">Search Medicine</h2>
            <p className="text-gray-400 mb-4 text-center sm:text-lg">
              To fetch detailed information about any medicine, follow these steps:
            </p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 sm:text-lg">
          ...
          {/* Additional Note */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-center sm:text-3xl">Note</h2>
            <p className="text-gray-400 text-center sm:text-lg">
